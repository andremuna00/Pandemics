...

{
	...
	private void initialize()
	{
		...
		panelInput.setBounds(10, 11, 480, 260);
		...
		lblProbInf.setBounds(60, 137, 150, 17);
		panelInput.add(lblProbInf);
		
		tfNumInf = new JTextField();
		tfNumInf.setBounds(290, 137, 86, 20);
		...
		lblProbRec.setBounds(60, 167, 150, 20);
		panelInput.add(lblProbRec);
		
		tfNumRec = new JTextField();
		tfNumRec.setBounds(290, 168, 86, 20);
		...
		panelButtons.setBounds(10, 280, 460, 182);
		...
		btnClean.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				main.start();
				modello=new Model(lato, p_c, p_m, p_g,p_v,time);
